# Syllabus: *Advanced Creative Coding* 

### 60-412/712, Spring 2026

* Title: *Advanced Creative Coding* (60-412/712), Spring 2026
* Time and Location: Mon/Wed, 2:00-4:50pm in CFA-303
* Departments: Carnegie Mellon University [School of Art](http://www.art.cmu.edu/) 
...
![Kent Rules](../resources/philo/corita_kent_10_rules.jpg)

*But, I relent, and provide some detailed policies:*
...
**This course is structured as 18 parallel independent studies.** I will be working with each of you individually, in parallel, while you also create a community of support for each other.
...
### Summary of Assignments Policy:

There will be 4 Assignments (Presentations) this semester.

* 😓 Forgo 1 Presentation: no impact on your grade whatsoever.
* 🤕 Forgo 2 Presentations: lose a letter grade.
* 💀 Forgo 3+ Presentations: fail the class.
...
* Understand how to document and present artworks that were created using code.
...
Your grades in this course will be based on your self-evident **fulfillment** of simple checklists. Projects will always have a checklist of *supporting requirements*. These are often very straightforward to fulfill, but if you fail to meet these, you will have points deducted. Practically every project assignment will ask you to check off subtasks such as (for example):
...
Because your grade reflects your fulfilment of basic checklists, it follows that I regularly give "**A**" grades to work that meets checklist criteria, but which I don't happen to think is particularly good or interesting.
...
**To receive critical feedback on your work**, your work should be available for evaluation during the designated review period. At four times this semester, your creative projects may be evaluated by your peers in an in-class critique, or potentially even by outside experts who review your work online. If your assignment is not viewable by the time those persons do their reviews, then your work may not receive feedback from them. Likewise, generally speaking, my feedback for late work is comparatively attenuated. 

**To receive full credit towards your grade**, projects should have minimum viable documentation online in time for your presentation date. If your work is more than a week late, I reserve the right to assume it is **foregone** (if you have not made an arrangement with me). If you know you're going to be just a little bit late with a project, *contact me* to arrange an accommodation.
...
There often isn't enough time to provide in-depth feedback for all students during critiques. If you would like more professor-feedback on a project, ask me.
...
**Credit is one of the most important forms of currency** in economies of commons-based peer production and open-source media arts. You are expected to **cite** the source of any code you use.
...
The projects in this course are primarily intended to be executed by individuals. That said, I am in favor of students collaborating if such collaborations arise organically. Please note the following expectations:
...
In this class, you are strongly encouraged to explore the affordances of generative AI as an instrument for art-making.

With only a few exceptions (I'll be clear), you are *affirmatively encouraged* to use generative AI systems (such as ChatGPT, Claude Code, or CoPilot) to assist you with your programming projects. Indeed: it is incumbent upon us to explore how these systems are changing the nature of creative coding and software development. In using AI systems in your classwork, please keep the following in mind:
